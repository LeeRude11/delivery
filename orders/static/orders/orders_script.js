...
function parseResult(resp, elements) {
  ...
  let item_price = elements['amount_container'].getElementsByClassName('item-price')[0]
  let item_cost = elements['amount_container'].getElementsByClassName('item-cost')[0]
